...
public class JuezTest {
    ...
    @Test
    public void obtenerEnfrentamientosJuez() {
        ...
        // Recuperación y verificación de datos
        assertEquals (1, juez1.obtenerEnfrentamientosJuez(torneo).size());
        assertTrue(juez1.obtenerEnfrentamientosJuez(torneo).contains(enfrentamiento));
