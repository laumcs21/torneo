...
public class JugadorTest {
    ...
    public void registrarJugadorEquipo() {
        ...
        var equipo = new Equipo("Uniquindio", representante, TipoEquipo.MIXTO);
    ...
    @Test
    public void registrarJugadorEquipoGeneroIncorrecto() {
        LOG.info("Inicio de prueba registrarJugadorEquipo...");
        // Almacenar los datos de prueba Equipo{Uniquindio} Representante{Robinson,Pulgarin,rpulgarin@email.com,6067359300}, Jugador {Christian,Candela,chrcandela@email.com,6067431234, fechaActual - 15 años}

        var representante = new Persona("Robinson", "Pulgarin", "rpulgarin@email.com", "6067359300");
        var equipo = new Equipo("Uniquindio", representante, TipoEquipo.FEMENINO);
        var jugador = new Jugador("Christian", "Candela", "chrcandela@email.com", "6067431234",LocalDate.now().minusYears(15),genero.MASCULINO);
    ...
    public void registrarJugadorTorneo() {
        ...
        LOG.info("Fin de prueba registrarJugadorTorneo...");
            ...
            /**
     * Verificar que se pueda registrar un equipo de tipo mixto al un torneo mixto
     * 
     */
    @Test
    public void registrarJugadorTorneoMixtoCorrecto() {
        LOG.info("Inicio de prueba registrarJugadorTorneo...");
        // Almacenar los datos de prueba Torneo{Copa Mundo\|fechaActual+ 1mes\| fechaActual - 15 días\|fechaActual+15 días\|24\|18\|0\|LOCAL}  Equipo{Uniquindio} Representante{Robinson,Pulgarin,rpulgarin@email.com,6067359300}, Jugador {Christian,Candela,chrcandela@email.com,6067431234, fechaActual - 15 años}

        
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)18, 0,TipoTorneo.LOCAL, CaracterTorneo.TorneoMixto);

        var representante = new Persona("Robinson", "Pulgarin", "rpulgarin@email.com", "6067359300");
        var equipo = new Equipo("Uniquindio", representante, TipoEquipo.MIXTO);
        var jugador = new Jugador("Christian", "Candela", "chrcandela@email.com", "6067431234",LocalDate.now().minusYears(15), genero.MASCULINO);
        var jugador1 = new Jugador("Valentina", "Arbelaez", "val0130@email.com", "6067465234",LocalDate.now().minusYears(15), genero.FEMENINO);
        ...
        /**
     * Verificar que no sea posible registrar un equipo mixto con solo jugadores de un genero a un torneo de tipo mixto
     * 
     */
    @Test
    public void registrarJugadorTorneoMixtoIncorrecto() {
        LOG.info("Inicio de prueba registrarJugadorTorneo...");
        // Almacenar los datos de prueba Torneo{Copa Mundo\|fechaActual+ 1mes\| fechaActual - 15 días\|fechaActual+15 días\|24\|18\|0\|LOCAL}  Equipo{Uniquindio} Representante{Robinson,Pulgarin,rpulgarin@email.com,6067359300}, Jugador {Christian,Candela,chrcandela@email.com,6067431234, fechaActual - 15 años}
        ...
        LOG.info("Fin de prueba registrarJugadorTorneo...");
            ...
            /**
     * Verificar que no sea posible registrar un jugador de genero diferente al del tipo del torneo, desde la clase torneo
     * 
     */
    @Test
    public void registrarJugadorTorneoGeneroIncorrecto() {
        LOG.info("Inicio de prueba registrarJugadorTorneo...");
        // Almacenar los datos de prueba Torneo{Copa Mundo\|fechaActual+ 1mes\| fechaActual - 15 días\|fechaActual+15 días\|24\|18\|0\|LOCAL}  Equipo{Uniquindio} Representante{Robinson,Pulgarin,rpulgarin@email.com,6067359300}, Jugador {Christian,Candela,chrcandela@email.com,6067431234, fechaActual - 15 años}

        
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)18, 0,TipoTorneo.LOCAL, CaracterTorneo.TorneoFemenino);
    ...
    public void registrarJugadorTorneoInscripcionesCerradas() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(1), (byte)24, (byte)18, 0,TipoTorneo.LOCAL, CaracterTorneo.TorneoMasculino);
    ...
    public void registrarJugadoresRepetidosTorneo() {
        ...
        var torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)18, 0,TipoTorneo.LOCAL, CaracterTorneo.TorneoMasculino);

        var representante = new Persona("Robinson", "Pulgarin", "rpulgarin@email.com", "6067359300");
        var equipo = new Equipo("Uniquindio", representante, TipoEquipo.MASCULINO);
        var equipo2 = new Equipo("Quindío", representante, TipoEquipo.MASCULINO);
        torneo.registrarEquipo(equipo);
